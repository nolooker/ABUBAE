import { BoardValidationError, validateBoardCommentEditInput, validateBoardId } from '@/lib/board'
...
export async function PATCH(request: Request, context: Context) {
  try {
    ...
    let input
    try {
      input = validateBoardCommentEditInput(body)
    } catch (error) {
    ...
    return Response.json(await repository.updateComment(commentId, input))
  } catch (error) {
